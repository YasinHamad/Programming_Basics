...
int main()
{
	while (true) {
		...
		cout << "Vacation From: " << datetime::PrintDateLong(date1) << "\n";
		cout << "Vacation To: " << datetime::PrintDateLong(date2) << "\n\n";

		cout << "Actual vacation days is: " << GetVacationDays(date1, date2) << " Day(s)" << "\n";
