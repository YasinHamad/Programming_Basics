...
/* --------------------------------- FUNCTIONS --------------------------------- */
// see datetime::DifferentBtwDatesInDays function 
...
int main()
{
	while (true) {
		...
		cout << datetime::DifferentBtwDatesInDays(date1, date2) << endl;
		cout << datetime::DifferentBtwDatesInDays(date1, date2, true) << endl;
