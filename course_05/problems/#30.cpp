...
int main()
{
	...
	while (1)
	{
		...
		int arr1[SIZE], size, arr2[SIZE], arr3[SIZE];

		size = ReadPositiveNum("Enter arrays size: ");

		FillArrayWithRandomValues(arr1, size);
		FillArrayWithRandomValues(arr2, size);

		PrintArray(arr1, size);
		PrintArray(arr2, size);

		SumTwoArray(arr1, arr2, size, arr3);
