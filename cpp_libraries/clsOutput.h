...
public:
	...
	void TestColors() {
		//cout << C_RESET << "This is the original color" << "\n";
		//cout << C_NOT_IMP << "This is not important text" << "\n";

		//cout << C_DARK_RED << "This is dark red" << "\n";
		//cout << C_DARK_GREEN << "This is dark green" << "\n";
		//cout << C_DARK_YELLOW << "This is dark yellow" << "\n";
		//cout << C_DARK_BLUE << "This is dark blue" << "\n";
		//cout << C_DARK_PINK << "This is dark pink" << "\n";
		//cout << C_DARK_SKY << "This is dark sky" << "\n";

		//cout << C_RESET << "---------------\n";

		//cout << C_DARK_RED_B << "This is dark red background" << "\n";
		//cout << C_DARK_GREEN_B << "This is dark green background" << "\n";
		//cout << C_DARK_YELLOW_B << "This is dark yellow background" << "\n";
		//cout << C_DARK_BLUE_B << "This is dark blue background" << "\n";
		//cout << C_DARK_PINK_B << "This is dark pink background" << "\n";
		//cout << C_DARK_SKY_B << "This is dark sky background" << "\n";
		//cout << C_DARK_GRAY_B << "This is dark gray background" << "\n";

		//cout << C_RESET << "---------------\n";

		cout << C_LIGHT_RED << "This is light red" << "\n";
		cout << C_LIGHT_GREEN << "This is light green" << "\n";
		cout << C_LIGHT_YELLOW << "This is light yellow" << "\n";
		cout << C_LIGHT_BLUE << "This is light blue" << "\n";
		cout << C_LIGHT_PINK << "This is light pink" << "\n";
		cout << C_LIGHT_SKY << "This is light sky" << "\n";

		cout << C_RESET << "---------------\n";
		cout << "\033[4m" << "This is light red" << "\n";

		cout << C_LIGHT_RED_B << "This is light red background" << "\n";
		cout << C_INVERT << "This is light gray background" << "\n";
		cout << C_RESET << "This is light gray background" << "\n";
		cout << C_LIGHT_GREEN_B << "This is light green background" << "\n";
		cout << C_LIGHT_YELLOW_B << "This is light yellow background" << "\n";
		cout << C_LIGHT_BLUE_B << "This is light blue background" << "\n";
		cout << C_LIGHT_PINK_B << "This is light pink background" << "\n";
		cout << C_LIGHT_SKY_B << "This is light sky background" << "\n";

		cout << C_RESET << "---------------\n";

		//cout << "\033[7m" << "this is the text" << "\n";
		//cout << C_RESET << "---------------\n";
		//cout << "\033[100m" << "this is the text" << "\n";
		//cout << C_RESET << "---------------\n";
		//cout << "\033[47m" << "this is the text" << "\n";
		//cout << C_RESET << "---------------\n";
		//cout << "\033[107m" << "this is the text" << "\n";
		cout << C_RESET << "---------------\n";
	}
